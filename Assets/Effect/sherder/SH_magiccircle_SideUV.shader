Shader "Unlit/SH_magiccircle_SideUV"
{
    Properties
    {
        ...
        _MaskPower ("Bottom Mask Power", Range(0.1, 5)) = 1
        _MaskInvert ("Bottom Mask Invert 0=Normal 1=Invert", Range(0, 1)) = 0

        _TopMaskPower ("Top Mask Power", Range(0.1, 5)) = 1
        _TopMaskStrength ("Top Mask Strength", Range(0, 1)) = 1
        _TopAreaPower ("Top Area Power", Range(0.1, 5)) = 2
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(v2f i) : SV_Target
            {
                ...
                // 横方向に流す
                mainUV.x = frac(mainUV.x - _Time.y * _ScrollSpeed);
