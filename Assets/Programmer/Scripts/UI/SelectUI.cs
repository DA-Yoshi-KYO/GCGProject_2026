...
public class GimmickSelectUI : MonoBehaviour
{
    ...
    // ──────────────────────────────────────────
    [Header("接続先")]
    [Tooltip("PlayerAction が付いているプレイヤーオブジェクト")]
    ...
    private void Update()
    {
        ...
        bool isSetting = playerAction.currentMode == PlayerAction.PlayerMode.Setting;
    ...
    private void ForceUpdateAll()
    {
        ...
        cachedMode = playerAction.currentMode == PlayerAction.PlayerMode.Setting;
