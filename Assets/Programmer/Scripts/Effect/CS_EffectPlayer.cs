...
public static class CS_EffectPlayer
{
    ...
    {
        return Play(cs_EffectPrefab, position, Quaternion.identity, null, -1.0f);
    }
    ...
    {
        return Play(cs_EffectPrefab, position, rotation, null, -1.0f);
    }

    /// <summary>
    /// エフェクトPrefabを生成して再生します。
    /// デフォルト再生速度を使用します。
    /// </summary>
    ...
    public static CS_EffectHandle Play(CSE_EffectId effectId, Vector3 position)
    {
        ...
        return Play(effectPrefab, position);
    }
    ...
    public static CS_EffectHandle Play(CSE_EffectId effectId, Vector3 position, Quaternion rotation)
    {
        ...
        return Play(effectPrefab, position, rotation);
    }
